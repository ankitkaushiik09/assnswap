...
import com.kaushik.assnswap.Adapter.MessageAdapter;
import com.kaushik.assnswap.Fragments.APIService;
...
import com.kaushik.assnswap.Notifications.Client;
import com.kaushik.assnswap.Notifications.Data;
import com.kaushik.assnswap.Notifications.MyResponse;
import com.kaushik.assnswap.Notifications.Sender;
import com.kaushik.assnswap.Notifications.Token;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        profile_image.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(MessageActivity.this,userprofile.class);
        ...
        if (!bookName.equals (""))
        {
            text_send.setText ( "Hi "+userName+", I am interested in  "+bookName+"." );
        }
